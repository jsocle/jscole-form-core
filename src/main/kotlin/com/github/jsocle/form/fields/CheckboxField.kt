...
public open class CheckboxField<T : Any?>(public var choices: List<Pair<T, String>> = listOf(), mapper: FieldMapper<T>,
                                          defaults: List<T> = listOf()) : Field<T, Ul>(mapper, defaults) {
